...
from dream_cycle.config import (
    DREAM_DB, RETENTION_FLOOR, FADEMEM_BETA, DECAY_HALF_LIVES,
    ARCHIVE_THRESHOLD_DAYS, PROMOTION_MIN_SCORE, PROMOTION_MIN_RECALLS,
    PROMOTION_MIN_SESSIONS, PERMANENT_MARKERS, IMPORTANCE_WEIGHTS,
    DEDUP_THRESHOLD, MERGE_THRESHOLD, DEDUP_DIST, MERGE_DIST, CLUSTER_DIST,
    HKT, log,
)
...
from dream_cycle.similarity import (
    combined_similarity,
    match_memory_to_queries, get_vector_neighbors, batch_vector_clustering,
)
